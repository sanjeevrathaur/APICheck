...
/**
 *  A test which invokes Atm web service via an http client.
...
public class AtmControllerTest {
	...
	private String url = "http://localhost:8080/CeleritiDepositsAPI/services/atm";

	@BeforeClass
	public static void initialize() {
		queryParams.add("rqType", "");
	}
	...
	@Test
	public void testGetAtmCache() throws Exception {
